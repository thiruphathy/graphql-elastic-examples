...
export declare class ScalarsExplorerService extends BaseExplorerService {
    ...
    explore(): any[];
    filterImplicitScalar<T extends Record<string, Function | string> = any>(wrapper: InstanceWrapper<T>): {
        [x: string]: GraphQLScalarType;
    };
    getScalarsMap(): any[];
    filterExplicitScalar<T extends Record<string, Function | string> = any>(wrapper: InstanceWrapper<T>): {
        type: any;
